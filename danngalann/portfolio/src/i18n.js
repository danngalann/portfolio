  ...
  es: {
    translation: {
      ...
      projects: {
        ...
        portfolio: {
          text: "Mi portfolio personal y mi segundo proyecto implementando React en un backed con Django. Aquí he aprendido a conectar el SMTP de Gmail con Django para enviar mails desde el frontend React. También he ganado más practica usando GIT en un proyecto real, además de aprender a guardar credenciales secretas en un repositorio público. Es también la primera vez que he hecho una web multilenguaje."
        },
        notes: {
          title: "Notas React",
          text: "Aplicación de notas hecha con React. Aquí estaba intentando aprender cómo usar el almacenamiento local del navegador para guardar las notas del usuario. De esta forma, cada usuario en internet puede tener un conjunto único de notas sin tener que registrarse. También fue el primero proyecto donde utilicé React Transition Group para animar las notas según aparecen o desaparecen."
        }
      },
      about: {
        title: "Sobre mi",
        text: "Soy un desarrollador web React con una gran pasión por la inteligencia artificial y la visión computerizada. Mi viaje en el desarrollo web empezó hace dos años, cuando inicié un grado superior de DAW. He seguido aprendiento desde entonces, a través tanto de mis profesores como de recursos online. Me centro mayoritariamente en frontend (aunque he hecho un par de proyectos fullstack), pero mi pasión está en el aprendizaje automático y el análisis de datos. Mi sueño es juntar lo mejor de ambos mundos; implentar complejos modelos de inteligencia artificial en aplicaciones web sencillas para el usuario, haciendo el análisis de datos más accesible para todos."
      },
      contact: {
        header: "Contacto",
        name: "Nombre",
